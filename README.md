...
3. Run the container based on mscs502 image with `docker run -it --rm -v $PWD:/helloworld mscs502`
...
- Program version number should be incremented.  HINT: In *pom* and *global variables*
